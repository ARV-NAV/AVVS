...
class TestObjectPositionProcessing(unittest.TestCase):
    ...
    def test_get_object_angle(self):
        ...
        object_x = 960
        object_y = 200
        self.assertTrue(calculate_angle(width, height, viewport_angle, object_x) == 0)

        # Test for case where the object pixels are greater than the centerline
        object_x = 1560
        object_y = 700
        self.assertTrue(calculate_angle(width, height, viewport_angle, object_x) == 12.256530990813975)

        # Test for case where the object pixels are less than the centerline
        object_x = 500
        object_y = 700
        self.assertTrue(calculate_angle(width, height, viewport_angle, object_x) == -9.396673759624047)
